...
c={id:$(b).attr("id"),cl:$(b).attr("class")};b.p.pager&&$(b.p.pager).off().empty().removeClass("ui-state-miancontent ui-jqgrid-pager ui-corner-bottom");var
